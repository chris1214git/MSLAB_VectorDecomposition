...
if __name__ =='__main__':
    ...
    parser.add_argument('--ratio', type=float, default=0.8) # Training size
    ...
    if config['dataset2'] is not None:
        ...
        word_embeddings = get_word_embs(new_vocabularys, word_emb_file='../../data/glove.6B.300d.txt', data_type='tensor')
