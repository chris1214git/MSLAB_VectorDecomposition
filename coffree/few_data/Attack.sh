...
python attack_baseline.py --dataset=20news --ratio=0.2 --inductive=True | tee record/Attack_ind_20news_0.2.txt &&
python attack_baseline.py --dataset=20news --ratio=0.4 --inductive=True | tee record/Attack_ind_20news_0.4.txt &&
...
python attack_baseline.py --dataset=20news --ratio=0.2 | tee record/Attack_trans_20news_0.2.txt &&
python attack_baseline.py --dataset=20news --ratio=0.4 | tee record/Attack_trans_20news_0.4.txt &&
